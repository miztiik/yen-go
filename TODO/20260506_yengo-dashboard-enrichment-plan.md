...
- `rollback --dry-run --json` (already exists; pin the schema) → `{affected_puzzles: [id, ...], affected_runs: [...], reversible: bool}`.
- `vacuum-db --dry-run --json` → `{orphan_rows: N, orphan_files: M, freed_bytes_estimate, rebuild: bool}`.
