...
**Initiative:** `20260307-0000-feature-enrichment-lab-query-fix`
...
| Q7   | `enrich_single.py` decomposition                      | —                                                                                                                                             | —               | **Out of scope for this initiative. Already handled in `20260307-0000-refactor-enrich-single-decomposition` (at closeout).**           | answered |
