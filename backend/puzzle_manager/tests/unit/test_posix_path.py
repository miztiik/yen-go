...
class TestToPosixPath:
    ...
    def test_windows_path_string(self):
        ...
        windows_path = "sgf\\beginner\\batch-0001\\abc123.sgf"
        result = to_posix_path(windows_path)
        assert result == "sgf/beginner/batch-0001/abc123.sgf"
    ...
    def test_publish_path_scenario(self):
        ...
        output_path = Path("C:/project/yengo-puzzle-collections/sgf/beginner/batch-0001/abc.sgf")
        output_root = Path("C:/project/yengo-puzzle-collections")
        result = to_posix_path(output_path, relative_to=output_root)
        assert result == "sgf/beginner/batch-0001/abc.sgf"
    ...
    def test_daily_puzzle_ref_scenario(self):
        ...
        puzzle_path = "sgf\\intermediate\\batch-0002\\xyz789.sgf"
        result = to_posix_path(puzzle_path)
        assert result == "sgf/intermediate/batch-0002/xyz789.sgf"
