...
class TestPublishPosixPaths:
    ...
    def test_multiple_levels_have_posix_paths(self):
        ...
        for level in levels:
            # Simulate Windows-generated path
            windows_path = f"sgf\\{level}\\batch-0001\\test.sgf"
            posix_path = to_posix_path(windows_path)

            assert posix_path == f"sgf/{level}/batch-0001/test.sgf"
