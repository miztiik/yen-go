...
class TestAtomicWritePreventsPartialUpdates:
    ...
    def test_failed_write_preserves_original(self, tmp_path, existing_inventory):
        ...
        # Mock save to raise an exception during write
...
class TestInventoryUpdateInPublishContext:
    ...
    def test_stages_publish_new_updated(self, tmp_path, existing_inventory):
        """Publish stage updates stages.publish.new metric."""
        inventory_path = tmp_path / "inventory.json"
        inventory_path.write_text(
            json.dumps(existing_inventory.model_dump(mode="json"), indent=2),
            encoding="utf-8",
        ...
        result = manager.update_stage_metrics(
            stage="publish",
            metrics={"new": 10},
            run_id="test-run",
        )

        assert result.stages.publish.new == 110  # 100 + 10
...
class TestPublishIncrementsByQuality:
    ...
    def test_quality_via_inventory_manager(self, tmp_path):
        ...
        inventory_data = {
            ...
            "stages": {
                "ingest": {"attempted": 10, "passed": 10, "failed": 0},
                "analyze": {"enriched": 10, "skipped": 0},
                "publish": {"new": 10},
            },
        }
    ...
    def test_quality_preserved_when_not_incremented(self, tmp_path):
        ...
        inventory_data = {
            ...
            "stages": {
                "ingest": {"attempted": 5, "passed": 5, "failed": 0},
                "analyze": {"enriched": 5, "skipped": 0},
                "publish": {"new": 5},
            },
        }
