...
1. Each wrong answer costs 1 life (3 lives total)

1. Skipping costs 1 life

1. Build streaks for bonus points (1.5× multiplier at 5-streak)

1. Game ends when time runs out or all lives are lost
