...
1. Parse — Parse SGF strings

1. Validate — Structural validation

1. Deduplicate — D8 content hashing to detect duplicates

1. Classify — Assign difficulty levels

1. Tag — Detect techniques (ko, ladder, etc.)

1. Enrich — Generate hints, quality metrics

1. Solve — KataGo/yengo-source validation

1. Serialize — Write enriched SGF

1. Index — Build view indexes

1. Publish — Write final output
