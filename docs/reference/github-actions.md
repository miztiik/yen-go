...
1. **Validate**: Ensures all puzzles are valid before publishing (invalid puzzles are skipped)

1. **Commit**: Pushes generated puzzles to `yengo-puzzle-collections/`

1. **Deploy**: Automatically deploys to GitHub Pages after successful generation
...
1. ⚙️ Setup Python 3.11

1. 📦 Install puzzle manager (`pip install -e .`)

1. 📅 Determine date (from input or today's UTC date)

1. 🧩 Generate & validate puzzles (`python -m backend.puzzle_manager daily --date $DATE`)

1. 📤 Commit and push changes

1. 🚀 Deploy to GitHub Pages (automatic after generation)
...
1. Select **Daily Puzzle Generation**

1. Click **Run workflow**

1. Enter date in `YYYY-MM-DD` format (optional, defaults to today)
...
1. ⚙️ Setup Node.js 20

1. 📦 Install dependencies (`npm ci`)

1. 📁 Copy puzzles to public folder
...
1. Select **Deploy to GitHub Pages**

1. Click **Run workflow**

1. Select branch (usually `main`)
...
1. Review recent runs for the expected date
...
1. Click **Run workflow** → Select `main` → **Run workflow**
