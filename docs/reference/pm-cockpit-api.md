# pm_cockpit HTTP API Reference

> **Tier**: Reference (the *what*).
> **See also**: [Architecture: pm_cockpit](../architecture/tools/pm_cockpit.md) (the *why*),
> [How-to: run pm_cockpit](../how-to/tools/run-pm-cockpit.md) (daily ops),
...
`tools/pm_cockpit/server/models.py` are the canonical source for every shape.
...
Pydantic models in `tools/pm_cockpit/server/models.py` validate every
