...
| [Documentation Artifact Contract](documentation-artifact-contract.md) | Required documentation planning, validation, and closeout fields |

---

## Related Concepts

For definitions and detailed explanations, see:

| Topic | Go to |
| ----------------- | --------------------------------------------------------- |
| SGF Properties | [Concepts: SGF Properties](../concepts/sgf-properties.md) |
| Technique Tags | [Concepts: Tags](../concepts/tags.md) |
| Difficulty Levels | [Concepts: Levels](../concepts/levels.md) |
| Hint System | [Concepts: Hints](../concepts/hints.md) |
