...
1. It is a **research/analysis document** that informed a decision (the decision now lives in architecture/)

1. It is a **historical spec or design narrative** from a past initiative

1. It references **retired systems or deprecated pipelines**
...
1. Verify depth ≤ 3 levels

1. Add all required elements (title, Last Updated, See Also)

1. Update the README index for the target tier directory

1. Update all cross-references in related docs
