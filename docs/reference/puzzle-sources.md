...
1. SGF stored in staging area

1. Pipeline validates solution correctness

1. Pipeline classifies difficulty automatically

1. Pipeline assigns technique tags

1. Validated puzzle merged to main collection
...
1. Register in `config/sources.json`

1. Verify with `python -m backend.puzzle_manager sources`

1. Run import: `python -m backend.puzzle_manager run --source <id> --stage ingest`
