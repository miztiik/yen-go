...
| --- | --- | --- | --- |
| P0 | AI-solve implementation hardening | [Architecture: KataGo Enrichment](../architecture/tools/katago-enrichment.md) | Keep runtime behavior, validation, and docs aligned with the canonical enrichment design. |
| P0 | AI-solve remediation closure | [Architecture: KataGo Enrichment](../architecture/tools/katago-enrichment.md) | Finish the remaining hardening and validation follow-through from the original rollout. |
...
| P1 | KM search optimization follow-through | [Architecture: KataGo Enrichment](../architecture/tools/katago-enrichment.md) | Close the remaining KM-derived search-budget and review follow-up. |
