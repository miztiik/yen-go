...
export interface TechniqueBrowsePageProps {
  onNavigateBack: () => void;
 ...
 */
export const TechniqueBrowsePage: FunctionalComponent<TechniqueBrowsePageProps> = ({
  onNavigateBack,
  onSelectTechnique,
}) => {
...
export default TechniqueBrowsePage;
