/**
 * TrainingSelectionPage — Level-based training browser (redesigned).
 * @module pages/TrainingSelectionPage
 *
...
export interface TrainingSelectionPageProps {
...
export const TrainingSelectionPage: FunctionalComponent<TrainingSelectionPageProps> = ({
  onSelectLevel,
  onNavigateHome,
  onNavigateRandom,
}) => {
  ...
  const filteredLevels = useMemo(() => {
    ...
    return levels;
  }, [categoryFilter, filterState.tagId, dbReady]);
