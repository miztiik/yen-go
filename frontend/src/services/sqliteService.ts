...
const DB_PATH = '/yen-go/yengo-puzzle-collections/yengo-search.db';
const DB_VERSION_PATH = '/yen-go/yengo-puzzle-collections/db-version.json';
const WASM_PATH = '/yen-go/sql-wasm.wasm';
