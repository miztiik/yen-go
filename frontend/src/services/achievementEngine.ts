...
const ACHIEVEMENT_DEFINITIONS: readonly AchievementDefinition[] = [
  // Puzzle milestones
  {
    ...
    target: 1,
    evaluate: (p) => p.statistics.totalSolved,
  },
  {
    id: 'solve-10',
  ...
  // Perfect solves
  {
    id: 'perfect-5',
    name: 'Sharp Eye',
    description: '5 perfect solves',
    target: 5,
    evaluate: (p) => p.statistics.perfectSolves,
  },
  {
    id: 'perfect-25',
    name: 'Precision',
    description: '25 perfect solves',
    target: 25,
    evaluate: (p) => p.statistics.perfectSolves,
  },
  {
    id: 'perfect-100',
    name: 'Flawless',
    description: '100 perfect solves',
    target: 100,
    evaluate: (p) => p.statistics.perfectSolves,
  },
  ...
  // Streak achievements
  {
    ...
    target: 3,
    evaluate: (p) => p.streakData.currentStreak,
  },
  {
    id: 'streak-7',
    name: 'Weekly Warrior',
  ...
  {
    id: 'streak-longest-14',
    name: 'Consistency',
    description: '14-day longest streak',
    target: 14,
    evaluate: (p) => p.streakData.longestStreak,
  },
  {
    id: 'streak-longest-60',
    name: 'Unwavering',
    description: '60-day longest streak',
    target: 60,
    evaluate: (p) => p.streakData.longestStreak,
  },
  ...
  // Rush achievements
  {
    id: 'rush-50',
    name: 'Speed Reader',
    description: 'Rush score of 50+',
    target: 50,
    evaluate: (p) => maxRushScore(p),
  },
  {
    id: 'rush-100',
    name: 'Lightning',
    description: 'Rush score of 100+',
    target: 100,
    evaluate: (p) => maxRushScore(p),
  },
  ...
  // Time milestones
  {
    id: 'time-1h',
    name: 'Committed',
    description: 'Spend 1 hour solving',
    target: 3600000,
    evaluate: (p) => p.statistics.totalTimeMs,
  },
  {
    id: 'time-10h',
    name: 'Devoted',
    description: 'Spend 10 hours solving',
    target: 36000000,
    evaluate: (p) => p.statistics.totalTimeMs,
  },
  ...
  // Hint discipline
  {
    id: 'no-hints-10',
    name: 'Self-Reliant',
    description: '10 solves without hints',
    target: 10,
    evaluate: (p) => countNoHintSolves(p),
  },
  {
    id: 'no-hints-50',
    name: 'Independent',
    description: '50 solves without hints',
    target: 50,
    evaluate: (p) => countNoHintSolves(p),
  },
  {
    id: 'no-hints-100',
    name: 'Unassisted',
    description: '100 solves without hints',
    target: 100,
    evaluate: (p) => countNoHintSolves(p),
  },
];
