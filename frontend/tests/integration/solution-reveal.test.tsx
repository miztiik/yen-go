/**
 * SolutionReveal component — standalone tests.
 *
 * Note: SolutionReveal is no longer used in SolverView (replaced by
 * integrated tree navigation controls). These tests verify the component
 * still works correctly as a reusable widget if needed elsewhere.
 *
...
describe('SolutionReveal (standalone component)', () => {
  const totalSteps = 5;
