"""
Index file management for GoProblems puzzles.

Thin wrapper around tools.core.index with GoProblems-specific helpers.
...
logger = logging.getLogger("go_problems.index")
