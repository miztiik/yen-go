...
Uses tools.core.batching for all functionality with OGS-specific helpers.
"""
...
def get_batch_for_file_fast(
    ...
    Thin wrapper around tools.core.batching.get_batch_for_file_fast that
    extracts batch state from OGSCheckpoint.
