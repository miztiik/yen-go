...
besogo.makePastePanel = function(container, editor) {
    'use strict';

    var header = document.createElement('div');
    header.className = 'besogo-paste-header';

    var label = document.createElement('span');
    label.className = 'besogo-paste-label';
    label.appendChild(document.createTextNode('Paste SGF:'));
    header.appendChild(label);

    var loadBtn = document.createElement('input');
    loadBtn.type = 'button';
    loadBtn.value = 'Load';
    loadBtn.title = 'Load pasted SGF';
    ...
    clearBtn.title = 'Clear paste area';
    ...
    input.className = 'besogo-paste-textarea';
    input.placeholder = 'Paste SGF text here...';
    input.addEventListener('keydown', function(evt) {
        evt.stopPropagation(); // Prevent besogo key handlers while typing
    });
